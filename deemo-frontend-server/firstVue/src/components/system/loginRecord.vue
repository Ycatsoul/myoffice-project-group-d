   ...
   <div class="content">
     <div class="second">
       <el-row style="margin-top: 10px">
          ...
          <el-col :span="6" :offset="8" style="margin-top:25px;">
  ...
  data () {
    return {
      loginRecord:{
       ...
       loginRecords:[
        {
          loginRecordTitle:"ad123",
          loginRecordContent:"123456sssdsds ",
          recipientId:"小明好的哈哈"
        }
      ],
      multipleSelection: [],
   ...
   methods:{
     ...
     deleteManyLoginRecord(){
      ...
      doDeleteMultiLoginRecord(ids){
        ...
        this.postRequest("/employee/prize/deleteBatchPrize",datas).then(resp=> {
          ...
          if (resp && resp.status == 200) {
            var data = resp.data;
            this.$loginRecord({type: 'success', loginRecord: "删除成功！"});
      ...
      deleteLoginRecord(){
          ...
          this.doDeleteLoginRecord(row.id);
        }).catch(() => {
        });
      },
